...
export default function BranchesUpdate() {
  ...
  const handleReadBranch = () => {
    BranchService.read(branchId, {}, authUser?.token)
      .then((response) => {
        setBranch({
          name: response.data.branch.name,
          addressLine1: response.data.branch.address_line_1,
          addressLine2: response.data.branch.address_line_2,
          zipCode: response.data.branch.zip_code,
          city: response.data.branch.city,
          state: response.data.branch.state,
          country: response.data.branch.country,
          opening: response.data.branch.opening,
          closing: response.data.branch.closing,
        });
      })
      .catch((error) => {
